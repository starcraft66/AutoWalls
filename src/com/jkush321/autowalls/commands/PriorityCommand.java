        ...
        if (cmdSender.hasPermission("walls.op") || cmdSender.isOp()) {
            ...
            if (args.length == 3 && args[1].equalsIgnoreCase("set")) {
                ...
                if (Bukkit.getPlayer(args[0]) != null) {
                    ...
                    plugin.config.set("votes.players." + pl.getName(), priority);
                    plugin.saveConfig();
                    if (pl.isOnline()) {
                    ...
                    if (Bukkit.getPlayer(pl.getName()).hasPermission("walls.op") || cmdSender.isOp()) {
                    ...
                    plugin.config.set("votes.players." + pl, priority);
                    plugin.saveConfig();
